...
const CardDetail = ({ route }) => {
  ...
  function ingredient() {
    // l'api est toute nul y'a pas de liste d'ingedients va falloir parcourir les 20 ingrédients et vérifié que c'est pas nul
...
//   Function to list all the ingredients
